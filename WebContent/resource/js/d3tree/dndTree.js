...
function getServiceTreeData(_sid) {
    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            $("#contentpage .btn-group.row").css({"display":"contents"});
	...
	function DrawTree() {
		...
		function MonthlyReport(d, lastMonthCount){
			window.open('/ReportViewer.jsp?p=getCalculatedOutageReportOfSingleService&queryType=LAST_MONTH&sid=' + d.sid, '_blank');
