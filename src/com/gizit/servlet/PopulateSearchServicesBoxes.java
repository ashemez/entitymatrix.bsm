...
/**
 * Servlet implementation class PopulateSearchServicesBoxes
 */
@WebServlet("/PopulateSearchServicesBoxes")
public class PopulateSearchServicesBoxes extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PopulateSearchServicesBoxes() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	case loggedin:
    		...
    		services=ServiceFetchData.getAllSearchedServices(statusFilter);
    		Gson gson = new Gson();
